...
def parse_args():
    ...
    parser.add_argument('--batch_size', type=int, default=300, help='Number of images in each mini-batch')
    parser.add_argument('--test_batch_size', type=int, default=300, help='Number of images in each mini-batch')
    ...
    parser.add_argument('--network', type=str, default= 'MT_Net', help='The backbone of the network')  #### 'WRN28_5_wn'
    ...
    parser.add_argument('--labeled_batch_size', default=150, type=int, metavar='N', help="Labeled examples per minibatch (default: no constrain)")
...
def main(args):
    ...
    if load:
        ...
        # path_teacher = "checkpoint_paper/500_new/last.pth (2).tar"  ### 500 labels_new
